  ...
  <p>
    ...
    playersToShow.forEach((p, idx) => {
        ...
        const gamemodeIcons = {
            ...
            speed: "assets/gamemode-icons/Speed.svg",
            elytra: "assets/gamemode-icons/Elytra.svg",
            trident: "assets/gamemode-icons/Trident.svg",
            cart: "assets/gamemode-icons/Cart.svg",
            bed: "assets/gamemode-icons/Bed.svg",
            bow: "assets/gamemode-icons/Bow.svg",
            creeper: "assets/gamemode-icons/Creeper.svg",
            debuff: "assets/gamemode-icons/DeBuff.svg",
        ...
        if (displayRank === 1) {
            placementBadge =
                '<img src="assets/icons/Placement1.svg" alt="1st Place" style="position: absolute; width: 80px; height: 40px; z-index: 1; left: 50%; top: 50%; transform: translate(-50%, -50%);" />';
        } else if (displayRank === 2) {
            placementBadge =
                '<img src="assets/icons/Placement2.svg" alt="2nd Place" style="position: absolute; width: 80px; height: 40px; z-index: 1; left: 50%; top: 50%; transform: translate(-50%, -50%);" />';
        } else if (displayRank === 3) {
            placementBadge =
                '<img src="assets/icons/Placement3.svg" alt="3rd Place" style="position: absolute; width: 80px; height: 40px; z-index: 1; left: 50%; top: 50%; transform: translate(-50%, -50%);" />';
        } else {
            placementBadge =
                '<img src="assets/icons/PlacementOther.svg" alt="Rank" style="position: absolute; width: 80px; height: 40px; z-index: 1; left: 50%; top: 50%; transform: translate(-50%, -50%);" />';
        }
